...
public class MyBatisPlusGenerator {
   static String author = "zyl";
    ...
    private static TemplateConfig initTemplateConfig() {
        ...
        templateConfig.setEntity("autotemp/entity.java");
        templateConfig.setMapper("autotemp/mapper.java");
        templateConfig.setController("autotemp/controller.java");
        templateConfig.setService("autotemp/service.java");
        templateConfig.setServiceImpl("autotemp/serviceImpl.java");
